...
Gui, Font, s15
Gui, Add, Text, x1 y+15, OPEN CSGO
Gui, Font, cblue bold
Gui, Font, s12
Gui, Add, Text, x1 y+12, "F1" Bunnyhop (hold space)
Gui, Add, Text, x1 y+12, "F2" Rapid Fire on 0 key
Gui, Add, Text, x1 y+12, "F3" Press T to do 180
Gui, Add, Text, x1 y+12, "F4" AK-47
Gui, Add, Text, x1 y+12, "F5" M4A1
Gui, Add, Text, x1 y+12, "F6" M4A4
Gui, Add, Text, x1 y+12, "F7" FAMAS
Gui, Add, Text, x1 y+12, "F8" GALIL
Gui, Add, Text, x1 y+12, "F9" Close Script
Gui, Add, Text, x1 y+12, "F10" UMP-45
Gui, Add, Text, x1 y+12, "F11" AUG
Gui, Add, Text, x1 y+12, "F12" SG 553
Gui, Add, Text, x1 y+12, "LeftAlt" AUG and SG553 scoped
Gui, Font, cred bold
Gui, Add, Text, x1 y+11,  "5" PAUSE SCRIPT

Gui, -AlwaysOnTop
Gui, Color, Black
Gui, Show, w900 h510, NO RECOIL 2023 
